...
export type Endpoints = |"/find-user/"|"/flower/"|"/product/[productId]/"|"/profile/[contact]/"|"/users/[recordId]/[propertyId]/get/"|"/article/[articleId]/[repo]/"
...
import {onGet as endpoint5_onGet} from "./routes/article/[articleId]/[repo]/"
