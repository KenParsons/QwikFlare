...
export type Endpoints = |"/find-user/"|"/flower/"|"/product/[productId]/"|"/profile/[contact]/"|"/users/[recordId]/[propertyId]/get/"|"/orgs/[orgName]/[repo]/"
...
import {onGet as endpoint4_onGet} from "./routes/users/[recordId]/[propertyId]/get/"
import {onGet as endpoint5_onGet} from "./routes/orgs/[orgName]/[repo]/"
export interface HandlerTypesByEndpointAndMethod {"/find-user/":{"get": typeof endpoint0_onGet;"post": typeof endpoint0_onPost;};"/flower/":{"get": typeof endpoint1_onGet;};"/product/[productId]/":{"post": typeof endpoint2_onPost;};"/profile/[contact]/":{"post": typeof endpoint3_onPost;};"/users/[recordId]/[propertyId]/get/":{"get": typeof endpoint4_onGet;};"/orgs/[orgName]/[repo]/":{"get": typeof endpoint5_onGet;};}